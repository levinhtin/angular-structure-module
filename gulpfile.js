...
gulp.task('html:dev', function() {
  ...
  gulp.src(paths.webroot + 'src/index.html')
    .pipe(using())
    .pipe(inject(gulp.src(paths.appJs, {
      read: false
    }), {
    ...
    .pipe(inject(gulp.src(paths.appCss, {
      read: false
    }), {
      starttag: '<!-- inject:app:{{ext}} -->'
    }))
    .pipe(inject(gulp.src(paths.vendorCss, {
      read: false
    }), {
      starttag: '<!-- inject:vendor:{{ext}} -->'
    }))
...
gulp.task('html:debug', ['concat'], function() {
  return gulp.src(paths.webroot + 'src/index.html')
    .pipe(using())
    .pipe(inject(gulp.src(paths.webroot + 'dist/**/app*.min.js', {
      read: false
    }), {
      starttag: '<!-- inject:app:{{ext}} -->'
    }))
    .pipe(inject(gulp.src(paths.webroot + 'dist/**/vendor*.min.js', {
      read: false
    }), {
      starttag: '<!-- inject:vendor:{{ext}} -->'
    }))
...
gulp.task('html:release', ['min'], function() {
  return gulp.src(paths.webroot + 'src/index.html')
    .pipe(using())
    .pipe(inject(gulp.src(paths.webroot + 'dist/js/app*.min.js', {
      read: false
    }), {
      starttag: '<!-- inject:app:{{ext}} -->'
    }))
    .pipe(inject(gulp.src(paths.webroot + 'dist/js/vendor*.min.js', {
      read: false
    }), {
      starttag: '<!-- inject:vendor:{{ext}} -->'
    }))
    .pipe(inject(gulp.src(paths.webroot + 'dist/css/vendor*.min.css', {
      read: false
    }), {
      starttag: '<!-- inject:vendor:{{ext}} -->'
    }))
